<?php
/**
*  魅E音乐系统 Me Music V3.0
*  Copyright (c) 2009 - 2014 93Me. All rights reserved.
*  Authors: 93Me
**/
error_reporting(0);
...
if (!file_exists("$datadir/ipbans.php")) return;
	...
	for ($i=0; $i<$count; $i++) {
		...
		if ( strpos($i_p , $bannedip)===0 ) {
            Showmsg("no","对不起,您IP被禁止访问站,如有疑问,请联系管理员!","关闭本页","javascript:window.close()");
			exit;		
		}
	}
}
...
// 写文件
function writetofile($filename,$data,$method="rb+",$iflock=1,$check=1,$chmod=1)
{
