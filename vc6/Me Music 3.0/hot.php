...
if($songsum!=0){
  ...
  echo "<li><div align=\"center\">
		<input type='button' value='全选' onclick='sal(hot)' class=\"sbt\">\n
&nbsp;&nbsp;<input type='button' value='反选' onclick='opal(hot)' class=\"sbt\">\n
&nbsp;&nbsp;<input type='button' value='清空' onclick='clal(hot)' class=\"sbt\">\n
