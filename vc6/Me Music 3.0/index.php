...
<title>魅E音乐系统 - Me Music V3.0</title>
    <style type=\"text/css\">
...
<body>
<p><img src=images/93me.jpg></p>
	<h3>安装文件 install.php 还存在,请确认您已经安装了Me Music V3.0</h3>
  <ul>
   <li>如已经安装,为了确保系统的安全,请立刻将其改名或删除!</li>
   <li>如未安装请访问 <a href='install.php'>install.php</a> 进行安装!</li>
   <li>如果在安装上有什么问题,请联系我们寻求帮助!
  </ul>
</body>
</html>");
}
...
$n=0;
echo"-->";
echo "<form action=\"music.php\" method=\"post\" name=\"form".$singerid."\" onsubmit=\"FormWin(this,'musicbox')\">\n";
echo "<ul>";
for ($i=0; $i<$allnum; $i++){
