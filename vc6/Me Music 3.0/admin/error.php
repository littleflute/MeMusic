	   ...
	   if($count!=0){
	      ...
	      if ($page>$maxpageno) $page=$maxpageno;
			...
			for ($i=$pagemin; $i<=$pagemax; $i++) {
               ...
               $errtime=date("Y.m.d H:i",$detail[5]);
			   $list_info.="<tr class=bg><td width=\"12%\" height=25 align=\"center\">$detail[1]</td><td width=\"33%\" align=\"center\"><a href=\"play.php?id=$detail[3]\" target=_blank>$detail[2]</a></td><td width=\"10%\" align=\"center\">$detail[3]</td><td width=\"25%\" align=\"center\">$detail[4]</td><td align=\"center\">$errtime</td><td width=\"5%\" align=\"center\"><input type=\"checkbox\" name=\"delid[]\" value=\"$detail[5]\"></td></tr>\n";
	        }
		  echo $list_info;
	   }
	   else{
