...
echo "-->";
  ...
  echo "<li><span class=\"green\">".$user_nicheng."</span> ,您的音乐盒目前共收藏音乐 <span class=\"red\">".$allmusic."</span> 首,还可以收藏 <span class=\"red\">".$leftnum."</span>首(您最多可以收藏 <span class=\"red\">".$maxboxnum."</span>首)</li>";   
  echo "<!--";
}
