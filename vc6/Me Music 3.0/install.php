...
/*
	...
	魅E音乐系统 Me Music install.php - installation of Me Music v3.0
...
<html><head><title>Me Music - Installation</title>
...
<body bgcolor=#CCCCCC leftmargin=0 topmargin=5 marginwidth="0" marginheight="0">
...
style="COLOR: #cc0000">&gt;&gt;</span> Me Music v3.0 Installation 

</p>

  <p align="center"><img src="images/93me.jpg" width="250" height="102"></p>
...
欢迎来到 Me Music 安装向导,安装前请仔细,阅读安装说明里的每处细节后才能开始安装,安装文件夹里同样提供了有关软件安装的说明,请您同样仔细阅读,以保证安装进程的顺利进行!
...
版权所有 (c) 2009 - 2014
    ...
    在开始安装和使用 Me Music 之前,请务必仔细阅读本授权文档,在确定您理解和同意以下全部条款后,方可继续安装和使用!

    Me Music音乐系统(以下简称程序)是由93Me开发的音乐程序,基于PHP脚本和文本数据库,无需MySQL数据库支持,本程序是免费和开源程序,任何人都可以从互联网上免费下载,并可以在不违反本协议规定的前提下进行分发,且可以在不进行商业行为的前提下免费使用而无需缴纳程序使用费!
    ...
    在此,感谢您选择了Me Music,当发现问题,或有任何改进的建议,都可在官方网站(93Me.coM)、也可通过邮件渠道提出,再次感谢!
...
EOT;
	...
	<td class='t' align=center><font color="#0000EE"><b>Me Music 用户许可协议</b></font></td>
...
if($_POST['step']==1) {
	...
	echo "Me Music根目录 (Me Music目录) ....... <br>";
	...
	if ($check) {
		...
		echo '<tr><TD align=center class=r align=middle colSpan=2>资料已经写入,并已经注册成功!</TD></TR>';

		echo "<tr><td class='i' colspan='2' align='center'><span style='color:#CC0000'>&gt;</span>恭喜 Me Music 音乐系统,安装成功!<br>　</td></tr><tr><td class='t' align='center' width='50%'><b>管理员账号</b>:$adminname <b>密码为:$showpwd </b></td></tr><tr><td class='i' colspan='2' align='center'><span style='color:#CC0000'>&gt;</span><a href='admin.php'>点击这里进入管理面板,设置您的详细资料!</a><br><br></td></tr>";
